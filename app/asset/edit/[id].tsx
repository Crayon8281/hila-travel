...
export default function EditAssetScreen() {
  ...
  const { getAsset, updateAsset } = useAssetContext();
  ...
  useEffect(() => {
    if (asset) {
      ...
      setDescriptionHe(asset.description_he);
      setExpertNotes(asset.expert_notes);
      setTagsText(asset.tags.join(", "));
      setCostPrice(String(asset.cost_price));
      setSellingPrice(String(asset.selling_price));
    }
  }, [asset?._id]);
  ...
  const handleSave = () => {
    ...
    Alert.alert("נשמר", "הנכס עודכן בהצלחה", [
